...
def secure_biometric_iot_gatekeeper(student_id: str, biometric_token: str, proposed_action: str, timestamp_epoch: int) -> str:
    ...
    Args:
        student_id: The unique identifier of the authorized student/user.
        biometric_token: The 64-character HMAC-SHA256 signature generated by the mobile biometric app.
        proposed_action: The target IoT action topic to execute (e.g., 'iot/unlock').
        timestamp_epoch: The Unix epoch timestamp of when the token was generated on-device.
    """
